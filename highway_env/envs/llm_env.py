...
from highway_env.vehicle.behavior import AggressiveIDMVehicle, DefensiveIDMVehicle, TruckVehicle, MotorVehicle, IDMVehicle
...
class LLMEnv(AbstractEnv):
    ...
    def calculate_long_and_lat_risk_indices(self, ego_vehicle: Vehicle, other_vehicle: Vehicle) -> Tuple[float, float]:
    ...
    def calculate_TTC_near_miss(self) -> Tuple[float, float, float]:
