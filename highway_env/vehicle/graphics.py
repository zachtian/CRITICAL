...
from highway_env.vehicle.behavior import IDMVehicle, LinearVehicle, AggressiveIDMVehicle, DefensiveIDMVehicle, TruckVehicle, MotorVehicle, RegularIDMVehicle
...
class VehicleGraphics(object):
    ...
    EGO_COLOR = GREEN
    AGGRESSIVE_COLOR = (255, 0, 0)  
    DEFENSIVE_COLOR = (0, 0, 255)   
    TRUCK_COLOR = (0, 255, 0)  
    MOTOR_COLOR = (255, 255, 0)  
    @classmethod
    def display(
        cls,
        vehicle: Vehicle,
    ...
    def get_color(cls, vehicle: Vehicle, transparent: bool = False) -> Tuple[int]:
        ...
        elif isinstance(vehicle, MotorVehicle):
            color = cls.MOTOR_COLOR
        elif isinstance(vehicle, LinearVehicle):
            color = cls.YELLOW
        elif isinstance(vehicle, IDMVehicle) or isinstance(vehicle, RegularIDMVehicle):
            color = cls.BLUE
